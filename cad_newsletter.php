...
<head>
    ...
    <title>ADM - Syspan Cadastro de Newsletter</title>
    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Newsletter - Novo</h1>
                    </div><!-- /.col -->
                    <!-- <div class="col-sm-6">
        ...
        <div class="card card-dark col-12">
            ...
            <!-- form start -->
            <div class="container">
                <form action="./php/newsletter/insere_newsletter.php" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Informe o E-mail" required>
