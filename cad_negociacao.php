...
<head>
    ...
    <title>ADM - Syspan Cadastro de Tipo de Negociação</title>
    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tipo Negociação - Novo</h1>
                    </div><!-- /.col -->
                    <!-- <div class="col-sm-6">
        ...
        <div class="card card-dark col-12">
            <div class="card-header">
                <h3 class="card-title">Cadastro de Tipo de Negociacao</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <div class="container">
                <form action="./php/tipo_negociacao/insere_tp_negociacao.php" method="post">
                    <div class="card-body">
                        <!-- Label referente ao Link da imagem-->
                        <div class="form-group">
                            <label for="desc_tp_negociacao">DESCRIÇÃO:</label>
                            <input type="text" class="form-control" name="desc_tp_negociacao" id="desc_tp_negociacao" 
                            placeholder="Informe a descrição do tipo de negociacao" required>
                        </div>
                        <!-- ID Interno -->
                        <div class="form-group">
                            <label for="id_interno_tp_negociacao">ID INTERNO:</label>
                            <input type="number" class="form-control" name="id_interno_tp_negociacao" id="id_interno_tp_negociacao" 
                            placeholder="Informe a descrição do tipo de negociacao" required>
                        </div>
                    </div>
