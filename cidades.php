...
$sqlCidade = "SELECT id, nome, estado FROM cidade ORDER BY id DESC";
...
<head>
  ...
  <title>ADM - Syspan Cidades</title>
  ...
  <div class="content-wrapper" style="position: relative;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cidades - Listagem</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <!-- /.content-header -->
      <a href="cad_cidades.php" class="btn btn-success" style="float:right; ">
      ...
      <div class="content" style="padding-top: 90px; table-layout: fixed; font-weight: bold;">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listagem Cidades</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="cidades" class="table table-bordered table-striped table-hover table-secondary"
                ...
                <tbody>
                  <?php
                          while ($rowCidade = $cidade->fetch_assoc()) { ?>
                            
                        <tr>
                            <td id="cod_cidade" name="cod_cidade"><?php echo $rowCidade["id"];?></td>
                            <td id="nome_cidade" name="nome_cidade"><?php echo $rowCidade["nome"];?></td>
                            <td id="estado_cidade" name="estado_cidade"><?php echo $rowCidade["estado"];?></td>
                            <!-- Btn Ações -->
                            <td>
                            <a href="edita_cidades.php?cod_cidade=<?php echo $rowCidade['id'];?>" role="button">
                              <i class="fa-solid fa-pen" style="color: blue;"></i></a>
                            </td>
                            <td>
                            <a href="./php/cidades/exclui_cidades.php?cod_cidade=<?php echo $rowCidade['id'];?>" role="button">
