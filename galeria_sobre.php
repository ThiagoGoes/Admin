    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Galeria Sobre - Edição</h1>
                    </div><!-- /.col -->
                    <!-- <div class="col-sm-6">
        ...
        <div class="card card-dark col-12">
            <div class="card-header">
                <h3 class="card-title">Edição do Sobre - Galeria</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <div class="container">
                <form action="./php/sobre/insert_imagem_sobre.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="cod_sobre" value="<?php echo $cod_sobre; ?>">
                    <div class="card-body">
                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="form-control" name="img_sobre[]" id="formFileMultiple" multiple required>
                      ...
                      <!-- Botão para cadastrar -->
                        ...
                        <!-- Botão Voltar -->
                        <a class="btn btn-dark" href="sobre.php" role="button"><i class="fa-solid fa-backward"
                          style="gap: 15px;"></i> Sobre</a>
                    </div>
                ...
                <?php
                    ...
                    $diretorio = './galerias/sobre/' . $rowEditaSobre['id'] . '/';
                    // echo $diretorio;
                    // Verifica se a pasta existe
                    if (!is_dir($diretorio)) {
                        echo 'Pasta não encontrada';
                    } else {
                        // encontra todas as imagens no diretório correspondente ao ID
                        ...
                        if (empty($imagens)) {
                            ...
                            foreach ($imagens as $imagem) {
                                ...
                                echo '<a href="exclui_imagem_sobre.php?imagem='.urlencode($diretorio.$caminho_imagem).'" class="btn btn-danger"">Deletar</a>';
                                echo '</div>';
