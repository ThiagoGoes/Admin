...
$sql = "SELECT * FROM tipo_negociacao ORDER BY id DESC";
$negociacao = $conn->query($sql);
...
<head>
  ...
  <title>ADM - Syspan Tipo de Negociação</title>
  ...
  <div class="content-wrapper" style="position: relative;">
    ...
    <div class="content-header">
      ...
      <script>
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tipo Negociação</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
    ...
    <div class="container">
      <!-- /.content-header -->
      <a href="cad_negociacao.php" class="btn btn-success" style="float:right; ">
      ...
      <div class="content" style="padding-top: 90px; table-layout: fixed; font-weight: bold;">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listagem Tipo Negociação</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="tp_negociacao" class="table table-bordered table-striped table-hover table-secondary"
                style="text-align: center;">
                  <thead>
                          ...
                          <tbody>
                          <?php 
                           while ($rowTpNegociacao = $negociacao->fetch_assoc()) { ?>
                           
                          <tr>
                            <td name="cod_tp_negociacao" id="cod_tp_negociacao" ><?php echo $rowTpNegociacao['id'];?></td>
                            <td name="descricao_tp_negociacao" id="descricao_tp_negociacao"><?php echo $rowTpNegociacao["descricao"]; ?></td>
                            <!-- <td name="id_interno_negociacao" id="id_interno_negociacao"><?php echo $rowTpNegociacao['id_interno'] ?></td> -->
                            <td>
                              <a href="edita_tp_negociacao.php?cod_tp_negociacao=<?php echo $rowTpNegociacao['id']; ?>">
                              <i class="fa-solid fa-pen" style="color: blue;"></i></a>
                            </td>
                            <td>
                              <a href="./php/tipo_negociacao/exclui_tp_negociacao.php?cod_tp_negociacao=<?php echo $rowTpNegociacao['id']; ?>">
