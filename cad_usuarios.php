...
<head>
    ...
    <title>ADM - Syspan Cadastro de Usuários</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="card card-dark col-12">
            ...
            <!-- form start -->
            <div class="container">
                <form action="./php/usuarios/insere_usuarios.php" method="post">
                    <div class="card-body">
                        ...
                        <!-- Label referente a Senha/Troca propriedade do campo -->
                        <div class="form-group">
                            <label for="senha_usuarios">SENHA:</label>
                            <div class="input-group">
                                <input type="password" class="form-control" 
                                name="senha_usuarios" id="senha_usuarios" 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="root_usuarios" name="root_usuarios">
                                <option value="0">0 - Não (Acesso Parcial)</option>
                                <option value="1">1 - Sim (Acesso Total)</option>
                            </select>
    ...
    <?php include_once('./navigation/footer.php'); ?>
        ...
        <!-- Função que troca a propriedade do campo Senha Forma de Botão -->
        <!-- <script>
            var btnMostrarSenha = document.getElementById("btnMostrarSenha");
            var inputSenha = document.getElementById("senha_usuarios");

            btnMostrarSenha.addEventListener("click", function () {
                if (inputSenha.type === "password") {
                inputSenha.type = "text";
                btnMostrarSenha.innerHTML = '<i class="fa fa-eye-slash"></i>';
                } else {
                inputSenha.type = "password";
                btnMostrarSenha.innerHTML = '<i class="fa fa-eye"></i>';
                }
            });
        </script> -->

        <!-- Função que troca a propriedade do campo Senha com Hover -->
        <script>
            var inputSenha = document.getElementById("senha_usuarios");
            
            document.getElementById("btnMostrarSenha").addEventListener("mouseover", function() {
                inputSenha.type = "text";
            });
            
            document.getElementById("btnMostrarSenha").addEventListener("mouseout", function() {
                inputSenha.type = "password";
            });
        </script>
