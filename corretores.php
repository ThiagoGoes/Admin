...
// Select os dados da tabela corretores;
$sql = "SELECT * FROM corretores ORDER BY id DESC";
$corretores = $conn->query($sql);
...
<head>
  ...
  <title>ADM - Syspan Corretores</title>
      ...
      <div class="content-wrapper" style="position: relative;">
        ...
        <div class="content-header">
          <div class="container-fluid">
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Corretores - Listagem</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <!-- /.content-header -->
          <a href="cad_corretores.php" class="btn btn-success" style="float:right; ">
          ...
          <div class="content" style="padding-top: 90px; table-layout: fixed; font-weight: bold;">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Listagem Corretores</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table id="corretores" class="table table-bordered table-striped table-hover table-secondary"
                    style="text-align: center;">
                      <thead>
                          <tr>
                            <th style="color: black;">ID</th>
                            <th style="color: black;">CORRETOR</th>
                          ...
                          <tbody>
                          <?php
                          while ($rowCorretores = $corretores->fetch_assoc()) { ?>
                          
                          <tr>
                            <td name="cod_corretor" id="cod_corretor"><?php echo $rowCorretores["id"]?></td>
                            <td name="name_corretor" id="nome_corretor"><?php echo $rowCorretores["nome"]; ?></td>
                            <td>
                              <a href="edita_corretores.php?cod_corretor=<?php echo $rowCorretores['id']?>" role="button">
                              <i class="fa-solid fa-pen" style="color: blue;"></i></a>
                            </td>
                            <td>
                              <a href="./php/corretores/exclui_corretores.php?cod_corretor=<?php echo $rowCorretores['id']?>" role="button">
