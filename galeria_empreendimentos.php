...
<head>
    ...
    <title>ADM - Syspan Edição Galeria do Sobre</title>
    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Galeria Empreendimentos - Edição</h1>
                    </div><!-- /.col -->
                    <!-- <div class="col-sm-6">
        ...
        <div class="card card-dark col-12">
            <div class="card-header">
                <h3 class="card-title">Edição do Empreendimentos - Galeria</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <div class="container">
                <form action="./php/empreendimentos/insert_imagem_empreendimentos.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="cod_empreendimentos" value="<?php echo $cod_empreendimentos; ?>">
                    <div class="card-body">
                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cod_empreendimentos" id="cod_empreendimentos"
                            disabled placeholder="Digite o titulo do Sobre" value="<?php echo $rowEditaEmpreendimentos['id']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="img-upload">FOTO:</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="form-control" name="img_empreendimentos[]" id="formFileMultiple" multiple required>
                            ...
                            <!-- <input type="hidden" name="cod_empreendimentos" value="<?php echo $rowEditaSobre['id']; ?>"> -->
                       <?php } ?>
                        </div>
                      ...
                      <!-- Botão para cadastrar -->
                        ...
                        <!-- Botão Voltar -->
                        <a class="btn btn-dark" href="empreendimentos.php" role="button"><i class="fa-solid fa-backward"
                          style="gap: 15px;"></i> Empreendimentos</a>
                    </div>
                ...
                <!-- </form> -->
                        ...
                        error_reporting(E_ALL);
                            ...
                            $diretorio = './galerias/empreendimentos/' . $rowEditaEmpreendimentos['id'] . '/';
                            // echo $diretorio;
                            ...
                            if (!is_dir($diretorio)) {
                                ...
                                //encontra todas as inmagens no diretório correspondente ao ID
                                $imagens = array_diff(scandir($diretorio), array('..', '.'));
                            // $imagens = glob($diretorio . '*.{jpg,jpeg,png,gif}', GLOB_BRACE);
                            // Verifica se a há imagens no diretório.
                            if (empty($imagens)) {
                            ...
                            foreach ($imagens as $imagem) {
                                    $caminho_imagem = $imagem;
                                        ...
                                        echo '<div class="card-header bg-dark">Empreendimentos</div>';
                                        echo '<img src="'.$diretorio.$caminho_imagem.'" class="card-img-top" style="height: 230px; gap: 15px;" alt="Imagem Empreendimentos">';
                                        echo '<div class="card-body">'; 
                                        echo '<p class="card-text"></p>';
                                        echo '<a href="exclui_imagem_empreendimentos.php?imagem='.urlencode($diretorio.$caminho_imagem).'" class="btn btn-danger"">Deletar</a>';
                                        echo '</div>';
