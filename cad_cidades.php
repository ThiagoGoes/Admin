...
<head>
    ...
    <title>ADM - Syspan Cadastro de Cidades</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="card card-dark col-12">
            ...
            <!-- form start -->
            <div class="container">
                <form action="./php/cidades/insere_cidades.php" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Informe o código do município" required>
                        ...
                        <div class="form-group">
                            <label for="id_interno_cidades">ID INTERNO:</label>
