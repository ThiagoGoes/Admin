...
<head>
    ...
    <title>ADM - Syspan Cadastro do Tipo de Imóvel</title>
    ...
    <div class="content-wrapper" style="position: relative;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tipo Imovel - Novo</h1>
                    </div><!-- /.col -->
                    <!-- <div class="col-sm-6">
        ...
        <div class="card card-dark col-12">
            ...
            <!-- form start -->
            <div class="container">
                <form action="./php/tipo_imovel/insere_tp_imovel.php" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Informe a descrição do tipo de imóvel" required>
                        </div>
                        <!-- ID Interno -->
                        <div class="form-group">
                            <label for="id_interno_tp_imovel">ID INTERNO:</label>
